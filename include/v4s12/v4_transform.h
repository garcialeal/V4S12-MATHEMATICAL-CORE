/*
 * v4_transform.h - Multiplication-Free V4 Butterfly Transform Engine
 ...
 */
static inline void v4_transform_1d(int32_t *a, int32_t *b, int32_t *c, int32_t *d) {
    const int32_t s0 = *a + *b;
    const int32_t d0 = *a - *b;
    const int32_t s1 = *c + *d;
    const int32_t d1 = *c - *d;
